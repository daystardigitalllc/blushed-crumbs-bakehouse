    ...
    public function save(Request $request)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            if ($logoFile->isValid()) {
                ...
                $logoFile->storeAs('tenants/' . $tenant->id . '/logos', $filename, 'public');
                $tenant->logo_path = 'storage/tenants/' . $tenant->id . '/logos/' . $filename;
            }
        }
        ...
        if ($request->hasFile('product_images')) {
            foreach ($request->file('product_images') as $idx => $file) {
                if ($file && $file->isValid()) {
                    ...
                    $path = 'storage/tenants/' . $tenant->id . '/gallery/' . $filename;
                    $galleryImages[] = $path;

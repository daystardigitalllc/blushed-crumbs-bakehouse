...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        // Brevo's transactional HTTP API (port 443) instead of SMTP — added
        // because this server's cloud provider blocks outbound SMTP ports
        // (25/465/587) by default, so the smtp mailer above just hangs and
        // times out no matter how correct the SMTP credentials are.
        // Registered via Mail::extend('brevo_api', ...) in AppServiceProvider.
        'brevo_api' => [
            'transport' => 'brevo_api',
        ],

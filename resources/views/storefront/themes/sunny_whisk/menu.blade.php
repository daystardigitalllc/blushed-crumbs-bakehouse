...
<div id="menu-page-view">
    <section class="sw-menu-hero-section">
        <span class="sw-menu-hero-subtitle">OUR OFFERINGS</span>
        <h1 class="sw-menu-hero-title">Menu &amp; Pricing</h1>
        <p style="font-size:1.05rem; color:var(--sw-ink); opacity:0.85; max-width:650px; margin:0 auto 24px auto;">Explore our handcrafted baked goods and custom options.</p>
    ...
    @if(!$hasMenuContent)
        ...
        <section style="max-width:700px; margin:70px auto; padding:60px 30px; text-align:center; background:var(--theme-card-bg, #ffffff); border-radius:24px; border:2px dashed var(--primary, #ff4f9e); box-shadow:0 10px 30px rgba(0,0,0,0.04);">
            ...
            <h2 style="font-family:var(--theme-heading-font); color:var(--sw-ink); font-size:1.8rem; margin-bottom:12px;">Menu Coming Soon</h2>

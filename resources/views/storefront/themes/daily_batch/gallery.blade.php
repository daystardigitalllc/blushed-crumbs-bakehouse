...
<div id="gallery-page-view">
    <section class="db-page-hero">
        ...
        <h1 class="db-page-hero-title">{{ $tenant->getSiteContent('gallery_hero_title', 'Our Gallery') }}</h1>
        <p style="font-size:1.05rem; color:var(--db-ink); max-width:600px; margin:14px auto 0 auto; padding:0 15px;">{{ $tenant->getSiteContent('gallery_hero_text', 'Explore our latest custom creations uploaded directly from our kitchen!') }}</p>
    </section>
        ...
        <div class="gallery-masonry-grid db-featured-grid" id="public-gallery-grid">
            ...
            @empty
                <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; color: #888;">
                    ...
                    <h3 style="color: var(--db-ink); margin-bottom: 8px;">{{ $tenant->getSiteContent('gallery_empty_title', 'No Gallery Photos Published Yet') }}</h3>

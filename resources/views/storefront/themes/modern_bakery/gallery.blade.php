...
<div id="gallery-page-view">
    <section class="modern-page-hero">
        ...
        <h1 class="modern-page-hero-title">Gallery</h1>
        <p style="font-size:1.05rem; color:var(--dark-text); max-width:600px; margin:14px auto 0 auto; padding:0 15px; opacity:0.75;">Explore our latest custom creations uploaded directly from our kitchen!</p>
    </section>

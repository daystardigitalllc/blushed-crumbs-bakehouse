    ...
    <section>
        ...
        <div class="midnight-ingredients-list">
            ...
            <div class="midnight-ingredient-row">
                ...
                <div>
                    <h3>{{ $tenant->getSiteContent('about_ingredients.2.title', 'Consistent Quality') }}</h3>
                    <p>{{ $tenant->getSiteContent('about_ingredients.2.text', 'Every order is held to the same high standard, every time.') }}</p>
                </div>
            </div>
            <div class="midnight-ingredient-row">

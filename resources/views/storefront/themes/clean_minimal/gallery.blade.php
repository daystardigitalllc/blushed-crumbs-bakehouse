...
<div id="gallery-page-view">
    <section class="midnight-page-hero">
        ...
        <h1 class="midnight-page-hero-title">{{ $tenant->getSiteContent('gallery_hero_title', 'Gallery') }}</h1>
    </section>
    ...
    <section class="gallery-page-section" style="padding-top:60px;">
        ...
        <!-- gallery-masonry-grid is kept (not renamed) since app.js's filter
             ...
             rectangular grid crop is layered on via midnight-grid. -->
        <div class="gallery-masonry-grid midnight-grid" id="public-gallery-grid">
            ...
            @empty
                <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; color: #888;">
                    <span class="material-symbols-outlined midnight-icon" style="font-size: 3rem; display: block; margin-bottom: 12px;">photo_camera</span>

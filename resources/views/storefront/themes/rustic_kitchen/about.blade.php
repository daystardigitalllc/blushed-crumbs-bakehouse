...
<div id="about-page-view">
    ...
    <!-- MEET THE FOUNDER SECTION — copy first, photo second (reversed from
         the default layout) so the story leads instead of the photo -->
    ...
    <!-- THE INGREDIENTS BEHIND SECTION — two-column list instead of a 6-card grid -->

...
<div id="gallery-page-view">
    <section class="lb-page-hero">
        ...
        <h1 class="lb-page-hero-title">Our Gallery</h1>
        <p style="font-size:1.05rem; color:var(--lb-ink); max-width:600px; margin:14px auto 0 auto; padding:0 15px;">Explore our latest custom creations uploaded directly from our kitchen!</p>
    </section>
        ...
        <div class="gallery-masonry-grid lb-featured-grid" id="public-gallery-grid">
            ...
            @empty
                <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; color: #888;">
                    ...
                    <h3 style="color: var(--lb-ink); margin-bottom: 8px;">No Gallery Photos Published Yet</h3>

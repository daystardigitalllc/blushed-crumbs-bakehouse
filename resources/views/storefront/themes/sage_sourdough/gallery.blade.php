...
<div id="gallery-page-view">
    <section class="sg-page-hero">
        <span class="sg-page-hero-kicker">Follow Along</span>
        <h1 class="sg-page-hero-title">Our Gallery</h1>
        <p style="font-size:1.05rem; color:var(--sg-forest); max-width:600px; margin:14px auto 0 auto; padding:0 15px;">Explore our latest creations, straight from the kitchen.</p>
    </section>
    ...
    <section class="gallery-page-section" style="padding-top:0;">
        ...
        <div class="gallery-masonry-grid sg-featured-grid" id="public-gallery-grid">
            @forelse($gallery as $item)
                ...
                <div class="gallery-card" data-category="{{ $item->category }}" onclick="openLightbox('{{ asset($src) }}', '')">
                    <div class="gallery-card-img-wrap">
                        <img src="{{ asset($src) }}" alt="{{ $item->title ?: $tenant->name . ' Bakery Creation' }}" loading="lazy" decoding="async">
                    </div>
            ...
            @empty
                <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; color: #888;">
                    <span class="material-symbols-outlined sg-icon" style="font-size: 3rem; display: block; margin-bottom: 12px;">photo_camera</span>
                    <h3 style="color: var(--sg-forest); margin-bottom: 8px;">No Gallery Photos Published Yet</h3>

...
<div id="gallery-page-view">
    <section class="cb-page-hero">
        <span class="cb-page-hero-kicker">Follow Along</span>
        <h1 class="cb-page-hero-title">Our Gallery</h1>
        <p style="font-size:1.05rem; color:#4a2833; max-width:600px; margin:14px auto 0 auto; padding:0 15px;">Explore our latest creations, straight from the kitchen.</p>
    </section>
    ...
    <section class="gallery-page-section" style="padding-top:0;">
        ...
        <div class="gallery-masonry-grid cb-featured-grid" id="public-gallery-grid">
            ...
            @empty
                <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; color: #888;">
                    <span class="material-symbols-outlined cb-icon" style="font-size: 3rem; display: block; margin-bottom: 12px;">photo_camera</span>
                    <h3 style="color: var(--cb-cherry); margin-bottom: 8px;">No Gallery Photos Published Yet</h3>
